...
const usersCollection = client.db('beachResortBD').collection('users')
const roomsCollection = client.db('beachResortBD').collection('rooms')
const bookingsCollection = client.db('beachResortBD').collection('bookings')
...
app.get('/', (req, res) => {
  res.send('Hello from beach-resort Server..')
})
